...
import 'package:yes_play_music/pages/player/components/music_info_component.dart';
...
class PlayerBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double sidePadding = SizeUtil.screenWidth(context) / 10;
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    MusicInfoComponent(audio: musicPlayerState.currentAudio),
                    const Spacer(),
                    CommonMusicControls(
                    ...
                    Container(
                      child: Row(
                        children: [MusicListButton(), PlayOrderButton()],
                      ),
                    )
                  ],
                ),
